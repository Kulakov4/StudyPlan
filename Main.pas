...
uses DBServConnectionPooler, MyDataAccess, MyConnection, CMdLine,
  ...
  EssenceGridView, CSEView, SqlExpr, StudyPlanFactorsView2,
  Qualifications, System.Win.Registry, System.IOUtils, EducationalStandarts,
  AdoptionDatesForm, StudyPlanAdoption, UMKAdoption, SoftwareDocument,
  SoftwareView, SpecEducSimple, DisciplineNames, OptionsHelper, GridViewForm,
  DiscNameGroup, DiscNameView, MyDir, GetSpecEdBySP;
