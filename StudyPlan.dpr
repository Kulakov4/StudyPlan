...
uses
  ...
  CourcesNames in 'CourcesNames.pas',
  DPODisciplineNames in 'DPODisciplineNames.pas',
  ...
  DPOPlanView in 'DPOPlanView.pas' {dsgvDPOStudyPlan: TFrame},
  ...
  AdmissionGridView2 in 'AdmissionGridView2.pas' {AdmissionGV: TFrame},
  ...
  CourcesView in 'Views\CourcesView\CourcesView.pas' {ViewCources: TFrame},
  CourceGroup in 'Queryes\CourceGroup.pas',
